...
class ClockWidget(object):
    ...
    def update_lunar_info(self):
        ...
        self.lunar_info = "{}{}年 {}{}月{}  {}".format(
            ClockWidget.GAN[lunar_day.Lyear2.tg], 
            ClockWidget.ZHI[lunar_day.Lyear2.dz], 
            "闰" if lunar_day.Lleap else "", 
            ClockWidget.YMC[lunar_day.Lmc], 
            ClockWidget.RMC[lunar_day.Ldi], 
            ClockWidget.JIEQI[lunar_day.jqmc]
        )
    ...
    def update_all(self, cycle):
        ...
        if self.update_count % cycle == 0:
            ...
            updated2 = self.update_date_info()
            updated3 = self.update_lunar_info()
...
if __name__ == "__main__":
    ...
    c.update_date_info()
    c.update_lunar_info()
    print(c.date_info, c.time_info, c.lunar_info)
